...
-- nvim-notify bg color warning fix
...
-- Pane navigation and Splits
vim.keymap.set("n", "<leader>x", "<Cmd>only<CR>", { desc = "Close all splits but the currently selected one" })
vim.keymap.set("n", "<leader>|", "<Cmd>vsplit<CR>", { desc = "Create vertical split" })
vim.keymap.set("n", "<leader>_", "<Cmd>split<CR>", { desc = "Create horizontal split" })
...
-- Wraps
vim.keymap.set('x', "wi'", "xi''<Esc>P", {})
vim.keymap.set('x', 'wi"', 'xi""<Esc>P', {})
vim.keymap.set('x', 'wi(', 'xi()<Esc>P', {})
vim.keymap.set('x', 'wi[', 'xi[]<Esc>P', {})
vim.keymap.set('x', 'wi[', 'xi[]<Esc>P', {})

-- Transparent BG Plugin
vim.keymap.set("n", "<leader>tp", "<Cmd>TransparentToggle<CR>", { desc = "TransparentToggle" })
...
--   vim.api.nvim_set_hl(0, 'LineNrAbove', { fg = '#7287fd', bold = false })
--   vim.api.nvim_set_hl(0, 'LineNr', { fg = '#209fb5', bold = false })
--   vim.api.nvim_set_hl(0, 'LineNrBelow', { fg = '#7287fd', bold = false })
-- end
function LineNumberColors()
